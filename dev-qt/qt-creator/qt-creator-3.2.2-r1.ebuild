...
IUSE="debug doc examples test qt5 ${QTC_PLUGINS[@]%:*}"
...
src_configure() {
	EQMAKE${QTS}_EXCLUDE="share/qtcreator/templates/*
			tests/*"
	eqmake${QTS} IDE_LIBRARY_BASENAME="$(get_libdir)" \
		IDE_PACKAGE_MODE=1 \
